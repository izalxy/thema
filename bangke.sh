...
echo -e "\033[32mWHATSAPP  : 6287756544990\033[0m"
echo -e "\033[31mDEVELOVER : @IzalStarboy\033[0m"
echo ""
...
REPO_URL="https://github.com/izalxy/thema"
TEMP_DIR="thema"
...
echo -e "${GREEN}Installing ${YELLOW}sudo${GREEN} if not installed${RESET}"
    ...
    1)
        ...
        GITHUB_TOKEN="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"
...
echo -e "${BLUE} KETIK yes UNTUK MELANJUTKAN${RESET}"
    ...
    2A)
   REPO_URL="https://github.com/izalxy/LeXcZUbot"
TEMP_DIR="LeXcZUbot"
