...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/izalxy/thema"
export IZAL_STR="https://github.com/izalxy/thema"
...
update_lib_source() {
  ...
  if ! curl -sSL "$IZAL_STR/lib/lib.sh" -o /tmp/lib.sh; then
